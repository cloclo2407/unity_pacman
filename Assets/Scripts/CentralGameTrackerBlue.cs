...
public static class CentralGameTrackerBlue
{
    ...
    public static bool isBlue = true;
    ...
    private static void updateFood()
    {
        ...
        foodClusters.Sort((a, b)=>CompareClusters(a, b));
    }
    ...
    public static Vector3Int? CheckForFoodLoss()
    {
